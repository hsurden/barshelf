...
enum WindowMoveError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .windowNotMatched: "Barkeep could not uniquely match this icon to its live menu-bar window."
        case .windowChanged: "The menu-bar window changed before the move could start. Try again."
        case .deliveryUnavailable: "macOS did not allow Barkeep to deliver the targeted move."
