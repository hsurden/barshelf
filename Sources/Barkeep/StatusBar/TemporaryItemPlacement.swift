...
/// Barkeep's own control and divider participate so empty sections work too.
struct TemporaryItemPlacement {
    ...
    static let controlID = "barkeep.temporary.control"
    static let boundaryID = "barkeep.temporary.boundary"
