...
enum MenuBarSpacingService {
    ...
    private static let savedSpacingKey = "BarShelf.OriginalStatusItemSpacing"
    private static let savedPaddingKey = "BarShelf.OriginalStatusItemSelectionPadding"
    private static let hadSpacingKey = "BarShelf.HadOriginalStatusItemSpacing"
    private static let hadPaddingKey = "BarShelf.HadOriginalStatusItemSelectionPadding"
    private static let changedKey = "BarShelf.ChangedStatusItemSpacing"

    static func apply(settings: BarShelfSettings) {
