...
private let scanLog = Logger(subsystem: "com.hsurden.barshelf", category: "scan")
...
final class AccessibilityScanner: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.hsurden.barshelf.accessibility", qos: .userInitiated)
    private let probeQueue = DispatchQueue(
        label: "com.hsurden.barshelf.accessibility.probe",
        qos: .userInitiated,
