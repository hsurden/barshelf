...
final class PermissionAssistant {
    ...
    static let accessibilityChanged = Notification.Name("BarShelfAccessibilityChanged")
        ...
        VStack(alignment: .leading, spacing: 10) {
            HStack(alignment: .top, spacing: 10) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    Text("Turn on BarShelf in the list above.")
                        .font(.callout)
            ...
            Text("If BarShelf is missing, select + below. You can also drag this app tile into the list.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
        .padding(14)
