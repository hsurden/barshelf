...
swiftc -O \
    $(find Sources/Barkeep -name '*.swift' -print | sort) \
    -o "$executable_path"

cp Sources/Barkeep/Info.plist "$info_path"
...
# Create it once: self-signed "Barkeep HS Signing" cert trusted for codeSign.
